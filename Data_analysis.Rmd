...
table_yearly_avg_min_avg_soilwater <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(min_avg_soilwater = min(avg_soilwater)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_min_avg_soilwater = mean(min_avg_soilwater)) 

table_yearly_avg_min_avg_snowstorage <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(min_avg_snowstorage = min(avg_snowstorage)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_min_avg_snowstorage = mean(min_avg_snowstorage)) 

table_yearly_avg_min_avg_airtmp <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(min_avg_airtmp = min(avg_airtmp)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_min_avg_airtmp = mean(min_avg_airtmp)) 

table_yearly_avg_min_avg_precip <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(min_avg_precip = min(avg_precip)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_min_avg_precip = mean(min_avg_precip)) 

table_yearly_avg_max_avg_glorad <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(max_avg_glorad = max(avg_glorad)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_max_avg_glorad = mean(max_avg_glorad)) 

table_yearly_avg_max_avg_relhum <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(max_avg_relhum = max(avg_relhum)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_max_avg_relhum = mean(max_avg_relhum)) 

table_yearly_avg_min_avg_infiltration <- hydro_total %>%
  group_by(waterlevel, YY, hydro_year, member) %>%
  summarise(min_avg_infiltration = min(avg_infiltration)) %>%
  group_by(waterlevel, YY, hydro_year) %>%
  summarise(avg_min_avg_infiltration = mean(min_avg_infiltration)) 
...
saveRDS(object = table_yearly_avg_min_avg_soilwater, 
        file = "data/tables/driver_analysis/table_yearly_avg_min_avg_soilwater.RDS")
saveRDS(object = table_yearly_avg_min_avg_snowstorage, 
        file = "data/tables/driver_analysis/table_yearly_avg_min_avg_snowstorage.RDS")
saveRDS(object = table_yearly_avg_min_avg_airtmp, 
        file = "data/tables/driver_analysis/table_yearly_avg_min_avg_airtmp.RDS")
saveRDS(object = table_yearly_avg_min_avg_precip, 
        file = "data/tables/driver_analysis/table_yearly_avg_min_avg_precip.RDS")
saveRDS(object = table_yearly_avg_max_avg_glorad, 
        file = "data/tables/driver_analysis/table_yearly_avg_max_avg_glorad.RDS")
saveRDS(object = table_yearly_avg_max_avg_relhum, 
        file = "data/tables/driver_analysis/table_yearly_avg_max_avg_relhum.RDS")
saveRDS(object = table_yearly_avg_min_avg_infiltration, 
        file = "data/tables/driver_analysis/table_yearly_avg_min_avg_infiltration.RDS")
...
ggplot(data = table_yearly_avg_min_avg_soilwater, mapping = aes(x = YY, y = avg_min_avg_soilwater, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Minimum der täglichen oberflächennahen \nrelativen Bodenfeuchte je Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Oberflächennahen relative Bodenfeuchte: 60 Tage rolling mean, 100-fach skaliert, zentriert") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_min_avg_soilwater.png", width = 12, height = 9)

ggplot(data = table_yearly_avg_min_avg_snowstorage, mapping = aes(x = YY, y = avg_min_avg_snowstorage, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Minimum an täglichem Schneespeicher \nje Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Schneespeicher: 30 Tage rolling mean, zentriert") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_min_avg_snowstorage.png", width = 12, height = 9)

ggplot(data = table_yearly_avg_min_avg_airtmp, mapping = aes(x = YY, y = avg_min_avg_airtmp, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Minimum an täglicher Lufttemperatur \nje Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Lufttemperatur: 7 Tage rolling mean, zentriert") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_min_avg_airtmp.png", width = 12, height = 9)

ggplot(data = table_yearly_avg_min_avg_precip, mapping = aes(x = YY, y = avg_min_avg_precip, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Minimum an täglichem Niederschlag \nje Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Niederschlag: 7 Tage rolling mean, zentriert") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_min_avg_precip.png", width = 12, height = 9)

ggplot(data = table_yearly_avg_max_avg_glorad, mapping = aes(x = YY, y = avg_max_avg_glorad, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Maximum an täglich einfallender \nkurzwelligen Strahlung je Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Einfallende kurzwellige Strahlung: 7 Tage rolling mean") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_max_avg_glorad.png", width = 12, height = 9)

ggplot(data = table_yearly_avg_max_avg_relhum, mapping = aes(x = YY, y = avg_max_avg_relhum, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Maximum an täglicher relativer \nLuftfeuchtigkeit je Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Relative Luftfeuchtigkeit: 7 Tage rolling mean") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_max_avg_relhum.png", width = 12, height = 9)

ggplot(data = table_yearly_avg_min_avg_infiltration, mapping = aes(x = YY, y = avg_min_avg_infiltration, color = waterlevel)) +
  geom_line() +
  geom_point() +
  labs(title = "Jährliches durchschnittliches Minimum an täglicher Wasserleitfähigkeit \nje Jahreszeit im Zeitverlauf (aller Member)",
       ...
       x = "Datum", 
       caption = "Wasserleitfähigkeit: 7 Tage rolling mean") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
    scale_color_brewer(palette = "Dark2") +
  facet_wrap(vars(hydro_year), labeller = as_labeller(c(`summer` = "Sommer", `winter` = "Winter")))
ggsave("Plots/Chris/analysis/driver_plots/yearly_avg_min_avg_infiltration.png", width = 12, height = 9)
```
...
subset_hydro_winter_10304 <- subset(hydro_winter_10304, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
colnames(subset_hydro_winter_10304) <- c("Mittlerer Niederschlag", "Mittlere Lufttemperatur", "Mittlere Strahlung", "Mittlere relative Luftfeuchte", "Mittlere Bodenfeuchte", "Mittlerer Schneespeicher", "Grundwasserstand", "Mittlere Versickerung", "Maximaler Niederschlag", "Mittlere Schneeschmelze")

subset_hydro_winter_11502 <- subset(hydro_winter_11502, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
colnames(subset_hydro_winter_11502) <- c("Mittlerer Niederschlag", "Mittlere Lufttemperatur", "Mittlere Strahlung", "Mittlere relative Luftfeuchte", "Mittlere Bodenfeuchte", "Mittlerer Schneespeicher", "Grundwasserstand", "Mittlere Versickerung", "Maximaler Niederschlag", "Mittlere Schneeschmelze")

subset_hydro_winter_20203 <- subset(hydro_winter_20203, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
colnames(subset_hydro_winter_20203) <- c("Mittlerer Niederschlag", "Mittlere Lufttemperatur", "Mittlere Strahlung", "Mittlere relative Luftfeuchte", "Mittlere Bodenfeuchte", "Mittlerer Schneespeicher", "Grundwasserstand", "Mittlere Versickerung", "Maximaler Niederschlag", "Mittlere Schneeschmelze")

subset_hydro_summer_10304 <- subset(hydro_winter_10304, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
colnames(subset_hydro_summer_10304) <- c("Mittlerer Niederschlag", "Mittlere Lufttemperatur", "Mittlere Strahlung", "Mittlere relative Luftfeuchte", "Mittlere Bodenfeuchte", "Mittlerer Schneespeicher", "Grundwasserstand", "Mittlere Versickerung", "Maximaler Niederschlag", "Mittlere Schneeschmelze")

subset_hydro_summer_11502 <- subset(hydro_winter_11502, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
colnames(subset_hydro_summer_11502) <- c("Mittlerer Niederschlag", "Mittlere Lufttemperatur", "Mittlere Strahlung", "Mittlere relative Luftfeuchte", "Mittlere Bodenfeuchte", "Mittlerer Schneespeicher", "Grundwasserstand", "Mittlere Versickerung", "Maximaler Niederschlag", "Mittlere Schneeschmelze")

subset_hydro_summer_20203 <- subset(hydro_winter_20203, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
colnames(subset_hydro_summer_20203) <- c("Mittlerer Niederschlag", "Mittlere Lufttemperatur", "Mittlere Strahlung", "Mittlere relative Luftfeuchte", "Mittlere Bodenfeuchte", "Mittlerer Schneespeicher", "Grundwasserstand", "Mittlere Versickerung", "Maximaler Niederschlag", "Mittlere Schneeschmelze")
...
correlationp_pearson_winter_10304 <- cor.mtest(correlationm_pearson_winter_10304)
corrplot(correlationm_pearson_winter_10304, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_pearson_winter_10304$p)


# 11502
correlationm_pearson_winter_11502 <- cor(subset_hydro_winter_11502, method = "pearson", use = "complete.obs")
correlationp_pearson_winter_11502 <- cor.mtest(correlationm_pearson_winter_11502)
corrplot(correlationm_pearson_winter_11502, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_pearson_winter_11502$p)

# 20203
correlationm_pearson_winter_20203 <- cor(subset_hydro_winter_20203, method = "pearson", use = "complete.obs")
correlationp_pearson_winter_20203 <- cor.mtest(correlationm_pearson_winter_20203)
corrplot(correlationm_pearson_winter_20203, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_pearson_winter_20203$p)
...
correlationp_pearson_summer_10304 <- cor.mtest(correlationm_pearson_summer_10304)
corrplot(correlationm_pearson_summer_10304, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_pearson_summer_10304$p)

# 11502
correlationm_pearson_summer_11502 <- cor(subset_hydro_summer_11502, method = "pearson", use = "complete.obs")
correlationp_pearson_summer_11502 <- cor.mtest(correlationm_pearson_summer_11502)
corrplot(correlationm_pearson_summer_11502, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_pearson_summer_11502$p)

# 20203
correlationm_pearson_summer_20203 <- cor(subset_hydro_summer_20203, method = "pearson", use = "complete.obs")
correlationp_pearson_summer_20203 <- cor.mtest(correlationm_pearson_summer_20203)
corrplot(correlationm_pearson_summer_20203, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_pearson_summer_20203$p)
...
corrplot(correlationm_spearman_winter_10304, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_spearman_winter_10304$p)
...
corrplot(correlationm_spearman_winter_11502, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_spearman_winter_11502$p)
...
corrplot(correlationm_spearman_winter_20203, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_spearman_winter_20203$p)
...
corrplot(correlationm_spearman_summer_10304, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_spearman_summer_10304$p)
...
corrplot(correlationm_spearman_summer_11502, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_spearman_summer_11502$p)
...
corrplot(correlationm_spearman_summer_20203, method = "number", type = "lower", tl.col = "black", p.mat = correlationp_spearman_summer_20203$p)
```
