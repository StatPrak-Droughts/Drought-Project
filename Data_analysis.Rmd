...
### Auto corr
```{r}
# separate datasets for each member
# winter
for (i in pegel_ids) {
...
library(car)
# mean acf (across all members) separated by each waterlevel and season
for (k in c("winter", "summer")) {
  for (i in pegel_ids) {
    assign(paste0("df_acf_", k, "_", i), data.frame(Names = 1:38))
    for (j in levels(hydro_total$member)) {
      assign(paste0("acf_", k, "_", i, "_", j), as.data.frame(acf(get(paste0("hydro_", k, "_", i, "_", j))$drainage, plot = FALSE)$acf))
      assign(paste0("df_acf_", k, "_", i), bind_cols(get(paste0("df_acf_", k, "_", i)), get(paste0("acf_", k, "_", i, "_", j))))
    }
    assign(paste0("acf_mean_", k, "_", i), rowMeans(get(paste0("df_acf_", k, "_", i))[, 2:11]))
  }
}
# 10304, Winter: Autokorrelation > 0.5 bis einschließlich lag = 9
# 10304, Summer: Autokorrelation > 0.5 bis einschließlich lag = 8
# 11502, Winter: Autokorrelation > 0.5 bis einschließlich lag = 3
# 11502, Summer: Autokorrelation > 0.5 bis einschließlich lag = 3
# 20203, Winter: Autokorrelation > 0.5 bis einschließlich lag = 4
# 20203, Summer: Autokorrelation > 0.5 bis einschließlich lag = 3

# ACF-Plots for member kbe separated by each waterlevel and season
acf(hydro_winter_10304_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 10304, winter")
acf(hydro_summer_10304_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 10304, summer")
acf(hydro_winter_11502_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 11502, winter")
acf(hydro_summer_11502_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 11502, summer")
acf(hydro_winter_20203_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 20203, winter")
acf(hydro_summer_20203_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 20203, summer")

# Partial autocorrelation function, mean pacf (across all members) seperated by each waterlevel and season
for (k in c("winter", "summer")) {
  for (i in pegel_ids) {
    assign(paste0("df_pacf_", k, "_", i), data.frame(Names = 1:37))
    for (j in levels(hydro_total$member)) {
      assign(paste0("pacf_", k, "_", i, "_", j), as.data.frame(pacf(get(paste0("hydro_", k, "_", i, "_", j))$drainage, plot = FALSE)$acf))
      assign(paste0("df_pacf_", k, "_", i), bind_cols(get(paste0("df_pacf_", k, "_", i)), get(paste0("pacf_", k, "_", i, "_", j))))
    }
    assign(paste0("pacf_mean_", k, "_", i), rowMeans(get(paste0("df_pacf_", k, "_", i))[, 2:11]))
  }
}
...
# PACF-Plots for member kbe seperated by each waterlevel and season
pacf(hydro_winter_10304_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 10304, winter")
pacf(hydro_summer_10304_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 10304, summer")
pacf(hydro_winter_11502_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 11502, winter")
pacf(hydro_summer_11502_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 11502, summer")
pacf(hydro_winter_20203_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 20203, winter")
pacf(hydro_summer_20203_kbe$drainage, xlab = "lag in days", main = "Autocorrelation between drainage observations for 20203, summer")
...
acf(hydro_summer_10304_kbe$airtmp, plot = FALSE)
acf(hydro_summer_10304_kbe$airtmp)
# -> Temperatur scheint autokorelliert zu sein

acf(hydro_summer_10304_kbe$soilwater, plot = FALSE)
acf(hydro_summer_10304_kbe$soilwater)

# -> oberflächennahe Bodenfeuchte scheint autokorreliert zu sein

acf(hydro_summer_10304_kbe$precip, plot = FALSE)
acf(hydro_summer_10304_kbe$precip)
# -> Niederschlag ist kaum autokorreliert
```
...
grid.arrange(event_summer_10304_tmp, event_summer_11502_tmp, event_summer_20203_tmp, ncol = 2)
...
grid.arrange(event_winter_10304_tmp, event_winter_11502_tmp, event_winter_20203_tmp, ncol = 2)
grid.arrange(event_winter_10304_tmp, event_winter_11502_tmp, event_winter_20203_tmp, 
             event_summer_10304_tmp, event_summer_11502_tmp, event_summer_20203_tmp, ncol = 3)
...
grid.arrange(event_summer_10304_precip, event_summer_11502_precip, event_summer_20203_precip, ncol = 2)
...
grid.arrange(event_winter_10304_precip, event_winter_11502_precip, event_winter_20203_precip, ncol = 2)
grid.arrange(event_winter_10304_precip, event_winter_11502_precip, event_winter_20203_precip, 
             event_summer_10304_precip, event_summer_11502_precip, event_summer_20203_precip, ncol = 3)
...
grid.arrange(event_summer_10304_glorad, event_summer_11502_glorad, event_summer_20203_glorad, ncol = 2)
...
grid.arrange(event_winter_10304_glorad, event_winter_11502_glorad, event_winter_20203_glorad, ncol = 2)
grid.arrange(event_winter_10304_glorad, event_winter_11502_glorad, event_winter_20203_glorad, 
             event_summer_10304_glorad, event_summer_11502_glorad, event_summer_20203_glorad, ncol = 3)
...
grid.arrange(event_summer_10304_relhum, event_summer_11502_relhum, event_summer_20203_relhum, ncol = 2)
...
grid.arrange(event_winter_10304_relhum, event_winter_11502_relhum, event_winter_20203_relhum, ncol = 2)
grid.arrange(event_winter_10304_relhum, event_winter_11502_relhum, event_winter_20203_relhum, 
             event_summer_10304_relhum, event_summer_11502_relhum, event_summer_20203_relhum, ncol = 3)
...
grid.arrange(event_summer_10304_groundwaterdepth, event_summer_11502_groundwaterdepth, event_summer_20203_groundwaterdepth, ncol = 2)
...
grid.arrange(event_winter_10304_groundwaterdepth, event_winter_11502_groundwaterdepth, event_winter_20203_groundwaterdepth, ncol = 2)
grid.arrange(event_winter_10304_groundwaterdepth, event_winter_11502_groundwaterdepth, event_winter_20203_groundwaterdepth, 
             event_summer_10304_groundwaterdepth, event_summer_11502_groundwaterdepth, event_summer_20203_groundwaterdepth, ncol = 3)
...
cor(x, y, method = "pearson")
glm(y~x, data = data.frame(x, y), family = binomial())
event_summer_10304_soil <- ggplot(data = data.frame(x, y), aes(x = x , y = y)) +
                            geom_point() +
                            geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
                            labs(title = "Summer 10304", x = "soil", y = "LowLevel")
y <- hydro_summer_11502$lowlevel
x <- hydro_summer_11502$soilwater
cor(x, y, method = "pearson")
glm(y~x, data = data.frame(x, y), family = binomial())
event_summer_11502_soil <- ggplot(data = data.frame(x, y), aes(x = x , y = y)) +
                            geom_point() +
                            geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
                            labs(title = "Summer 11502", x = "soil", y = "LowLevel")
y <- hydro_summer_20203$lowlevel
x <- hydro_summer_20203$soilwater
cor(x, y, method = "pearson")
glm(y~x, data = data.frame(x, y), family = binomial())
event_summer_20203_soil <- ggplot(data = data.frame(x, y), aes(x = x , y = y)) +
                            geom_point() +
                            geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
                            labs(title = "Summer 20203", x = "soil", y = "LowLevel")
grid.arrange(event_summer_10304_soil, event_summer_11502_soil, event_summer_20203_soil, ncol = 2)
...
cor(x, y, method = "pearson")
glm(y~x, data = data.frame(x, y), family = binomial())
event_winter_10304_soil <- ggplot(data = data.frame(x, y), aes(x = x , y = y)) +
                            geom_point() +
                            geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
                            labs(title = "Winter 10304", x = "Soil", y = "LowLevel")
y <- hydro_winter_11502$lowlevel
x <- hydro_winter_11502$soilwater
cor(x, y, method = "pearson")
glm(y~x, data = data.frame(x, y), family = binomial())
event_winter_11502_soil <- ggplot(data = data.frame(x, y), aes(x = x , y = y)) +
                            geom_point() +
                            geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
                            labs(title = "Winter 11502", x = "Soil", y = "LowLevel")
y <- hydro_winter_20203$lowlevel
x <- hydro_winter_20203$soilwater
cor(x, y, method = "pearson")
glm(y~x, data = data.frame(x, y), family = binomial())
event_winter_20203_soil <- ggplot(data = data.frame(x, y), aes(x = x , y = y)) +
                            geom_point() +
                            geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE) +
                            labs(title = "Winter 20203", x = "Soil", y = "LowLevel")
grid.arrange(event_winter_10304_soil, event_winter_11502_soil, event_winter_20203_soil, ncol = 2)
grid.arrange(event_winter_10304_soil, event_winter_11502_soil, event_winter_20203_soil, 
             event_summer_10304_soil, event_summer_11502_soil, event_summer_20203_soil, ncol = 3)
