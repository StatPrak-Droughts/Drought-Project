...
```{r Chris: Extreme value analysis}
### Quantile: -------------------------------------------------------------
...
rownames(quantile_percents_ranges) <- paste0(quantiles[-length(quantiles)]*100, "% - ", quantiles[-1]*100, "%")
...
# 10304
correlationm_pearson_winter_10304 <- cor(subset(hydro_winter_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson", use = "complete.obs")
correlationp_pearson_winter_10304 <- cor.mtest(correlationm_pearson_winter_10304)
# correlation drainage with avg_airtmp, with avg_soilwater and with avg_infiltration significant at level = 0.05
corrplot.mixed(correlationm_pearson_winter_10304, upper = "circle", lower = "number", lower.col = "black")
corrplot.mixed(correlationm_pearson_winter_10304, upper = "circle", lower = "number", lower.col = "black", p.mat = correlationp_pearson_winter_10304$p)

# 11502
correlationm_pearson_winter_11502 <- cor(subset(hydro_winter_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson", use = "complete.obs")
correlationp_pearson_winter_11502 <- cor.mtest(correlationm_pearson_winter_11502)
# correlation drainage with avg_soilwater significant at level = 0.05
corrplot.mixed(correlationm_pearson_winter_11502, upper = "circle", lower = "number", lower.col = "black")
corrplot.mixed(correlationm_pearson_winter_11502, upper = "circle", lower = "number", lower.col = "black", p.mat = correlationp_pearson_winter_11502$p)

# 20203
correlationm_pearson_winter_20203 <- cor(subset(hydro_winter_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson", use = "complete.obs")
correlationp_pearson_winter_20203 <- cor.mtest(correlationm_pearson_winter_20203)
# correlation drainage with avg_soilwater significant at level = 0.05
corrplot.mixed(correlationm_pearson_winter_20203, upper = "circle", lower = "number", lower.col = "black")
corrplot.mixed(correlationm_pearson_winter_20203, upper = "circle", lower = "number", lower.col = "black", p.mat = correlationp_pearson_winter_20203$p)


## summer

# 10304
correlationm_pearson_summer_10304 <- cor(subset(hydro_summer_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson")
correlationp_pearson_summer_10304 <- cor.mtest(correlationm_pearson_summer_10304)
# correlation drainage with avg_soilwater and avg_snowstorage significant at level = 0.05
corrplot.mixed(correlationm_pearson_summer_10304, upper = "circle", lower = "number", lower.col = "black")
corrplot.mixed(correlationm_pearson_summer_10304, upper = "circle", lower = "number", lower.col = "black", p.mat = correlationp_pearson_summer_10304$p)

# 11502
correlationm_pearson_summer_11502 <- cor(subset(hydro_summer_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson")
correlationp_pearson_summer_11502 <- cor.mtest(correlationm_pearson_summer_11502)
# correlation drainage with avg_soilwater and avg_snowstorage significant at level = 0.05
corrplot.mixed(correlationm_pearson_summer_11502, upper = "circle", lower = "number", lower.col = "black")
corrplot.mixed(correlationm_pearson_summer_11502, upper = "circle", lower = "number", lower.col = "black", p.mat = correlationp_pearson_summer_11502$p)

# 20203
correlationm_pearson_summer_20203 <- cor(subset(hydro_summer_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson")
correlationp_pearson_summer_20203 <- cor.mtest(correlationm_pearson_summer_20203)
# correlation drainage with avg_soilwater significant at level = 0.05
corrplot.mixed(correlationm_pearson_summer_20203, upper = "circle", lower = "number", lower.col = "black")
corrplot.mixed(correlationm_pearson_summer_20203, upper = "circle", lower = "number", lower.col = "black", p.mat = correlationp_pearson_summer_20203$p)
...
# 10304
correlationm_spearman_winter_10304 <- cor(subset(hydro_winter_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman", use = "complete.obs")
...
# 11502
correlationm_spearman_winter_11502 <- cor(subset(hydro_winter_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman", use = "complete.obs")
...
# 20203
correlationm_spearman_winter_20203 <- cor(subset(hydro_winter_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman", use = "complete.obs")
...
# 10304
correlationm_spearman_summer_10304 <- cor(subset(hydro_summer_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman")
...
# 11502
correlationm_spearman_summer_11502 <- cor(subset(hydro_summer_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman")
...
# 20203
correlationm_spearman_summer_20203 <- cor(subset(hydro_summer_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman")
