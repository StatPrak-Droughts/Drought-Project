...
ggplot(data = table_yearly_avg_max_infiltration, mapping = aes(x = YY, y = avg_max_infiltration, color = waterlevel)) +
  ...
  labs(title = "Jährliches durchschnittliches Maximum an täglicher Sickerung \nje Jahreszeit im Zeitverlauf (aller Member)",
       y = "Jährliches durchschnittliches Maximum an täglicher Sickerung \n(in mm/24h)",
       x = "Datum") +
  guides(color=guide_legend(title="Pegel")) +
    theme(text = element_text(size = 20),
          legend.position="bottom") +
...
subset_hydro_summer_10304 <- subset(hydro_summer_10304, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
...
subset_hydro_summer_11502 <- subset(hydro_summer_11502, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
...
subset_hydro_summer_20203 <- subset(hydro_summer_20203, select = c(avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
...
# IQA ca. 1.8%, Faktor 10 führt zu 18 0.1% Schritten
...
# IQA ca. 36, also führt Faktor 0.5 zu 18 2mm Schritten
...
# IQA ca. 5.3, also führt Faktor 3.3 zu 16 0.3 grad Schritten
...
# IQA ca. 3.3, also führt Faktor 5 zu 16 0.2 mm/m^2  Schritten
...
# IQA ca. 240, also führt Faktor 0.1 zu 24 10 Wh/m^2 Schritten
...
# IQA ca. 11, weshalb wir Faktor 1 nutzen
...
# IQA ca. 0.35, also führt Faktor 50 zu 17 0.02 (Infiltration Einheit)Schritten


groundwaterdepth <- c(hydro_summer_10304$groundwaterdepth, hydro_winter_10304$groundwaterdepth)
quantile(na.omit(groundwaterdepth),  c(0.25, 0.75))
# IQA ca. 0.45, also führt Faktor 33 zu 17 1/30 m schritten


avg_snowstorage_drain_scaled <- c(hydro_summer_10304$avg_snowstorage_drain_scaled, hydro_winter_10304$avg_snowstorage_drain_scaled)
quantile(na.omit(avg_snowstorage_drain_scaled),  c(0.25, 0.75))
# IQA ca. 55, also führt Faktor 0.33333 zu 17 3er Schritten



max_precip <- c(hydro_summer$max_precip, hydro_winter$max_precip_winter)
quantile(na.omit(max_precip),  c(0.25, 0.75))
# IQA ca. 15, also führt Faktor 1 zu 15 1ner Schritten
