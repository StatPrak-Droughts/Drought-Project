...
# winter
max_precip_winter <- as.numeric(rep(NA, length = nrow(hydro_winter)))
for(k in 7:length(max_precip_winter)) {
  if (all(hydro_winter$member[(k - 6):(k - 1)] == hydro_winter$member[k]) &&
    ...
    if (hydro_winter$MM[k] == 11) {
      if (all(hydro_winter$MM[(k - 6):(k - 1)] == 11)) {
        max_precip_winter[k] <- max(hydro_winter$precip[(k - 6):k])
      }
    } else {
    max_precip_winter[k] <- max(hydro_winter$precip[(k - 6):k])
    }
...
hydro_winter <- cbind(hydro_winter, max_precip_winter)

# summer
max_precip_summer <- as.numeric(rep(NA, length = nrow(hydro_summer)))
for(k in 7:length(max_precip_summer)) {
  if (all(hydro_summer$member[(k - 6):(k - 1)] == hydro_summer$member[k]) &&
    ...
    if (hydro_summer$MM[k] == 5) {
      if (all(hydro_summer$MM[(k - 6):(k - 1)] == 5)) {
        max_precip_summer[k] <- max(hydro_summer$precip[(k - 6):k])
      }
    } else {
    max_precip_summer[k] <- max(hydro_summer$precip[(k - 6):k])
    }
...
hydro_summer <- cbind(hydro_summer, max_precip_summer)
...
# 10304
correlationm_pearson_winter_10304 <- cor(subset(hydro_winter_10304, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson", use = "complete.obs")
...
# 11502
correlationm_pearson_winter_11502 <- cor(subset(hydro_winter_11502, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson", use = "complete.obs")
...
# 20203
correlationm_pearson_winter_20203 <- cor(subset(hydro_winter_20203, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson", use = "complete.obs")
...
# 10304
correlationm_pearson_summer_10304 <- cor(subset(hydro_summer_10304, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson")
...
# 11502
correlationm_pearson_summer_11502 <- cor(subset(hydro_summer_11502, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson")
...
# 20203
correlationm_pearson_summer_20203 <- cor(subset(hydro_summer_20203, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "pearson")
...
# 10304
correlationm_spearman_winter_10304 <- cor(subset(hydro_winter_10304, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman", use = "complete.obs")
...
# 11502
correlationm_spearman_winter_11502 <- cor(subset(hydro_winter_11502, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman", use = "complete.obs")
...
# 20203
correlationm_spearman_winter_20203 <- cor(subset(hydro_winter_20203, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman", use = "complete.obs")
...
# 10304
correlationm_spearman_summer_10304 <- cor(subset(hydro_summer_10304, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman")
...
# 11502
correlationm_spearman_summer_11502 <- cor(subset(hydro_summer_11502, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman")
...
# 20203
correlationm_spearman_summer_20203 <- cor(subset(hydro_summer_20203, select = c(drainage, avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration)), method = "spearman")
