...
### Auto corr
```{r}
acf(hydro_summer_10304_kbe$drainage, plot = FALSE)
# Autokorrelation hier > 0.5 bis einschließlich lag = 6
acf(hydro_summer_10304_kbe$drainage, xlab = "lag in days", ylab = "autocorrelation", main = "Autocorrelation between drainage observations")
durbinWatsonTest(gam_1)
# p < 0.05 -> Es scheint Autokorrelation vorzuliegen
