...
## 10304
sommer10304GLM <- glm(lowlevel ~ airtmp + precip + glorad + relhum + groundwaterdepth + soilwater100 + snowstorage, family = binomial(link='logit'), data = hydro_summer_10304)
#11502
sommer11502GLM <- glm(lowlevel ~ airtmp + precip + glorad + relhum + groundwaterdepth + soilwater100 + snowstorage, family = binomial(link='logit'), data = hydro_summer_11502)
#20203
sommer20203GLM <- glm(lowlevel ~ airtmp + precip + glorad + relhum + groundwaterdepth + soilwater100 + snowstorage, family = binomial(link='logit'), data = hydro_summer_20203)

##Winter
##10304
winter10304GLM <- glm(lowlevel ~ airtmp + precip + glorad + relhum + groundwaterdepth + soilwater100 + snowstorage, family = binomial(link='logit'), data = hydro_summer_10304)
#11502
winter11502GLM <- glm(lowlevel ~ airtmp + precip + glorad + relhum + groundwaterdepth + soilwater100 + snowstorage, family = binomial(link='logit'), data = hydro_winter_11502)
#20203
winter20203GLM <- glm(lowlevel ~ airtmp + precip + glorad + relhum + groundwaterdepth + soilwater100 + snowstorage, family = binomial(link='logit'), data = hydro_summer_20203)
...
plot_models(sommer10304GLM)
p <- last_plot() +
  scale_color_manual(values = c("yellow", "red", "blue","pink", "green", "purple" ), 
                     name = "Gewässer/Halbsjahr", 
                     labels = c("Winter 20203",  "Winter 11502",  "Winter 10304","Sommer 20203", 
                                "Sommer 11502", "Sommer 10304")) +
