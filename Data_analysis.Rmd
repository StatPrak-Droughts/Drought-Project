...
for (pegel in pegel_list) {
    ...
    for (j in 1:(length(quantiles_ranges)-1)) {
      ...
      quantile_percents_ranges[j, i] <- 
        sum((pegel[pegel[, col_name] >= quantile_values[j] & pegel[, col_name] < quantile_values[j+1],
                         "lowlevel"]) == "TRUE")/sum((pegel[, "lowlevel"]) == "TRUE")
    }
    i = i + 1
  }
  ...
  # Save the table as a PDF file
  pdf(paste0("tables/extreme_values/quantile_percents_ranges_", pegel_names[counter_names], ".pdf"), height=4, width=13)
  grid.table(quantile_percents_ranges)
  dev.off()
...
# 10304
correlationm_pearson_winter_10304 <- cor(subset(hydro_winter_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain)), method = "pearson", use = "complete.obs")
...
# 11502
correlationm_pearson_winter_11502 <- cor(subset(hydro_winter_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain)), method = "pearson", use = "complete.obs")
...
# 20203
correlationm_pearson_winter_20203 <- cor(subset(hydro_winter_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain)), method = "pearson", use = "complete.obs")
...
# 10304
subset_hydro_summer_10304 <- subset(hydro_summer_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
correlationm_pearson_summer_10304 <- cor(subset_hydro_summer_10304[complete.cases(subset_hydro_summer_10304), ], method = "pearson")
...
# 11502
subset_hydro_summer_11502 <- subset(hydro_summer_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
correlationm_pearson_summer_11502 <- cor(subset_hydro_summer_11502[complete.cases(subset_hydro_summer_11502), ], method = "pearson")
...
# 20203
subset_hydro_summer_20203 <- subset(hydro_summer_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
correlationm_pearson_summer_20203 <- cor(subset_hydro_summer_20203[complete.cases(subset_hydro_summer_20203), ], method = "pearson")
...
# 10304
correlationm_spearman_winter_10304 <- cor(subset(hydro_winter_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain)), method = "spearman", use = "complete.obs")
...
# 11502
correlationm_spearman_winter_11502 <- cor(subset(hydro_winter_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain)), method = "spearman", use = "complete.obs")
...
# 20203
correlationm_spearman_winter_20203 <- cor(subset(hydro_winter_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain)), method = "spearman", use = "complete.obs")
...
# 10304
subset_hydro_summer_10304 <- subset(hydro_summer_10304, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
correlationm_spearman_summer_10304 <- cor(subset_hydro_summer_10304[complete.cases(subset_hydro_summer_10304), ], method = "spearman")
...
# 11502
subset_hydro_summer_11502 <- subset(hydro_summer_11502, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
correlationm_spearman_summer_11502 <- cor(subset_hydro_summer_11502[complete.cases(subset_hydro_summer_11502), ], method = "spearman")
...
# 20203
subset_hydro_summer_20203 <- subset(hydro_summer_20203, select = c(avg_airtmp, avg_soilwater, avg_precip, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration, max_precip, avg_snowstorage_drain))
correlationm_spearman_summer_20203 <- cor(subset_hydro_summer_20203[complete.cases(subset_hydro_summer_20203), ], method = "spearman")
