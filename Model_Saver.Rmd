...
# 20203, Winter
gam_uni_selected_interac_winter_20203 <- gam(formula = lowlevel ~ YY  + s(avg_airtmp, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps") + ti(avg_airtmp, groundwaterdepth, bs = "ps") + ti(avg_soilwater, avg_snowstorage, bs = "ps"), family = binomial(), data = hydro_winter_20203_kbe, method = "REML")
...
roc.plot(hydro_winter_10304_test$lowlevel, hydro_winter_10304_pred)
...
# 20203 ---- Needs work definetly
hydro_winter_20203_pred <- predict(gam_uni_selected_interac_winter_20203, hydro_winter_20203_test, type = "response")
roc.plot(hydro_winter_20203_test$lowlevel, hydro_winter_20203_pred)

# Sommer ----
# 10304---- Looks good
hydro_summer_10304_pred <- predict(gam_uni_selected_interac_summer_10304, hydro_summer_10304_test, type = "response")
roc.plot(hydro_summer_10304_test$lowlevel, hydro_summer_10304_pred)
# 11502 ---- Looks good
hydro_summer_11502_pred <- predict(gam_uni_selected_interac_summer_11502, hydro_summer_11502_test, type = "response")
roc.plot(hydro_summer_11502_test$lowlevel, hydro_summer_11502_pred)
# 20203 ---- Looks good
hydro_summer_20203_pred <- predict(gam_uni_selected_interac_summer_20203, hydro_summer_20203_test, type = "response")
roc.plot(hydro_summer_20203_test$lowlevel, hydro_summer_20203_pred)
```

# Save Models ----
## Volle Modelle ----
```{r}
save(gam_all_summer_10304, file = "./models/gam_all_summer_10304.RDS")
save(gam_all_summer_11502, file = "./models/gam_all_summer_11502.RDS")
save(gam_all_summer_20203, file = "./models/gam_all_summer_20203.RDS")

save(gam_all_winter_10304, file = "./models/gam_all_winter_10304.RDS")
save(gam_all_winter_11502, file = "./models/gam_all_winter_11502.RDS")
save(gam_all_winter_20203, file = "./models/gam_all_winter_20203.RDS")
```
## Selected Modelle 1 ----
```{r}
save(gam_uni_selected_summer_10304, file = "./models/gam_uni_selected_summer_10304.RDS")
save(gam_uni_selected_summer_11502, file = "./models/gam_uni_selected_summer_11502.RDS")
save(gam_uni_selected_summer_20203, file = "./models/gam_uni_selected_summer_20203.RDS")

save(gam_uni_selected_winter_10304, file = "./models/gam_uni_selected_winter_10304.RDS")
save(gam_uni_selected_winter_11502, file = "./models/gam_uni_selected_winter_11502.RDS")
save(gam_uni_selected_winter_20203, file = "./models/gam_uni_selected_winter_20203.RDS")
```
## Selected Modelle 2 ----
```{r}
save(gam2_uni_selected_summer_10304, file = "./models/gam2_uni_selected_summer_10304.RDS")
save(gam2_uni_selected_summer_11502, file = "./models/gam2_uni_selected_summer_11502.RDS")
save(gam2_uni_selected_summer_20203, file = "./models/gam2_uni_selected_summer_20203.RDS")

save(gam2_uni_selected_winter_10304, file = "./models/gam2_uni_selected_winter_10304.RDS")
save(gam2_uni_selected_winter_11502, file = "./models/gam2_uni_selected_winter_11502.RDS")
save(gam2_uni_selected_winter_20203, file = "./models/gam2_uni_selected_winter_20203.RDS")
```
# GAM Interactions ----
```{r}
save(gam_uni_selected_interac_summer_10304, file = "./models/gam_uni_selected_interac_summer_10304.RDS")
save(gam_uni_selected_interac_summer_11502, file = "./models/gam_uni_selected_interac_summer_11502.RDS")
save(gam_uni_selected_interac_summer_20203, file = "./models/gam_uni_selected_interac_summer_20203.RDS")

save(gam_uni_selected_interac_winter_10304, file = "./models/gam_uni_selected_interac_winter_10304.RDS")
save(gam_uni_selected_interac_winter_11502, file = "./models/gam_uni_selected_interac_winter_11502.RDS")
save(gam_uni_selected_interac_winter_20203, file = "./models/gam_uni_selected_interac_winter_20203.RDS")
```
