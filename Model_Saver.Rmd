...
## Volle Modelle ----
```{r}
save(le_gam_all_summer_10304, file = "./le_models/le_gam_all_summer_10304.Rdata")
save(le_gam_all_summer_11502, file = "./le_models/le_gam_all_summer_11502.Rdata")
save(le_gam_all_summer_20203, file = "./le_models/le_gam_all_summer_20203.Rdata")

save(le_gam_all_winter_10304, file = "./le_models/le_gam_all_winter_10304.Rdata")
save(le_gam_all_winter_11502, file = "./le_models/le_gam_all_winter_11502.Rdata")
save(le_gam_all_winter_20203, file = "./le_models/le_gam_all_winter_20203.Rdata")
```
## Selected Modelle 1 ----
```{r}
save(le_gam_uni_selected_summer_10304, file = "./le_models/le_gam_uni_selected_summer_10304.Rdata")
save(le_gam_uni_selected_summer_11502, file = "./le_models/le_gam_uni_selected_summer_11502.Rdata")
save(le_gam_uni_selected_summer_20203, file = "./le_models/le_gam_uni_selected_summer_20203.Rdata")

save(le_gam_uni_selected_winter_10304, file = "./le_models/le_gam_uni_selected_winter_10304.Rdata")
save(le_gam_uni_selected_winter_11502, file = "./le_models/le_gam_uni_selected_winter_11502.Rdata")
save(le_gam_uni_selected_winter_20203, file = "./le_models/le_gam_uni_selected_winter_20203.Rdata")
```
## Selected Modelle 2 ----
```{r}
save(le_gam2_uni_selected_summer_10304, file = "./le_models/le_gam2_uni_selected_summer_10304.Rdata")
save(le_gam2_uni_selected_summer_11502, file = "./le_models/le_gam2_uni_selected_summer_11502.Rdata")
save(le_gam2_uni_selected_summer_20203, file = "./le_models/le_gam2_uni_selected_summer_20203.Rdata")

save(le_gam2_uni_selected_winter_10304, file = "./le_models/le_gam2_uni_selected_winter_10304.Rdata")
save(le_gam2_uni_selected_winter_11502, file = "./le_models/le_gam2_uni_selected_winter_11502.Rdata")
save(le_gam2_uni_selected_winter_20203, file = "./le_models/le_gam2_uni_selected_winter_20203.Rdata")
```
# GAM Interactions ----
```{r}
save(le_gam_uni_selected_interac_summer_10304, file = "./le_models/le_gam_uni_selected_interac_summer_10304.Rdata")
save(le_gam_uni_selected_interac_summer_11502, file = "./le_models/le_gam_uni_selected_interac_summer_11502.Rdata")
save(le_gam_uni_selected_interac_summer_20203, file = "./le_models/le_gam_uni_selected_interac_summer_20203.Rdata")

save(le_gam_uni_selected_interac_winter_10304, file = "./le_models/le_gam_uni_selected_interac_winter_10304.Rdata")
save(le_gam_uni_selected_interac_winter_11502, file = "./le_models/le_gam_uni_selected_interac_winter_11502.Rdata")
save(gam_uni_selected_interac_winter_20203, file = "./le_models/le_gam_uni_selected_interac_winter_20203.Rdata")
```
