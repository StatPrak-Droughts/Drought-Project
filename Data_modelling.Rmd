...
# GAM for lowlevel with avg drivers
```{r}
library(mgcv)

## which drivers have a high explanatory power per water level and per season 
# 10304, winter
levels(hydro_total$member)
gam_kbe_avg_10304_winter_test <- gam(lowlevel ~ s(avg_infiltration, bs = "ps"), data = hydro_winter_10304_kbe, family = binomial(), method = "REML")
summary(gam_kbe_avg_10304_winter_test)
# viel Erklärungskraft alleine (>= 10%): avg_airtmp, avg_glorad, avg_soilwater, avg_snowstorage, groundwaterdepth, avg_infiltration
# wenig Erklärungskraft alleine (< 10%): avg_precip, avg_relhum

# 10304, summer
gam_kbe_avg_10304_summer_test <- gam(lowlevel ~ s(avg_infiltration, bs = "ps"), data = hydro_summer_10304_kbe, family = binomial(), method = "REML")
...
# 11502, winter
gam_kbe_avg_11502_winter_test <- gam(lowlevel ~ s(avg_infiltration, bs = "ps"), data = hydro_winter_11502_kbe, family = binomial(), method = "REML")
summary(gam_kbe_avg_11502_winter_test)
# viel Erklärungskraft alleine: avg_precip, avg_glorad, avg_soilwater, avg_snowstorage, avg_infiltration
# wenig Erklärungskraft alleine: avg_airtmp, avg_relhum, groundwaterdepth

# 11502, summer
gam_kbe_avg_11502_summer_test <- gam(lowlevel ~ s(avg_infiltration, bs = "ps"), data = hydro_summer_11502_kbe, family = binomial(), method = "REML")
...
# wenig Erklärungskraft alleine: avg_airtmp, avg_glorad, avg_relhum

# 20203, winter
gam_kbe_avg_20203_winter_test <- gam(lowlevel ~ s(avg_infiltration, bs = "ps"), data = hydro_winter_20203_kbe, family = binomial(), method = "REML")
...
# wenig Erklärungskraft alleine: avg_airtmp, avg_glorad, groundwaterdepth

# 20203, summer
gam_kbe_avg_20203_summer_test <- gam(lowlevel ~ s(avg_infiltration, bs = "ps"), data = hydro_summer_20203_kbe, family = binomial(), method = "REML")
summary(gam_kbe_avg_20203_summer_test)
# viel Erklärungskraft alleine: avg_soilwater
# wenig Erklärungskraft alleine: avg_precip, avg_airtmp, avg_glorad, avg_relhum, avg_snowstorage, groundwaterdepth, avg_infiltration
