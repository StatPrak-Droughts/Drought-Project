...
for (i in pegel_ids) {
  for (j in levels(hydro_total$member)) {
    max_precip <- as.numeric(rep(NA, length = nrow(get(paste0("hydro_winter_", i, "_", j)))))
    for (k in 7:length(max_precip)) {
      if (all(!is.na(get(paste0("hydro_winter_", i, "_", j))$precip[(k - 6):k]))) {
        if (get(paste0("hydro_winter_", i, "_", j))$MM[k] == 11) {
          if (all(get(paste0("hydro_winter_", i, "_", j))$MM[(k - 6):k] == 11)) {
            max_precip[k] <- max(get(paste0("hydro_winter_", i, "_", j))$precip[(k - 6):k])
          }
        } else {
          max_precip[k] <- max(get(paste0("hydro_winter_", i, "_", j))$precip[(k - 6):k])
      }
    ...
    assign(paste0("hydro_winter_", i, "_", j), cbind(get(paste0("hydro_winter_", i, "_", j)), max_precip))  
  }
}
...
for (i in pegel_ids) {
  for (j in levels(hydro_total$member)) {
    max_precip <- as.numeric(rep(NA, length = nrow(get(paste0("hydro_summer_", i, "_", j)))))
    for (k in 7:length(max_precip)) {
      if (all(!is.na(get(paste0("hydro_summer_", i, "_", j))$precip[(k - 6):k]))) {
        if (get(paste0("hydro_summer_", i, "_", j))$MM[k] == 5) {
          if (all(get(paste0("hydro_summer_", i, "_", j))$MM[(k - 6):k] == 5)) {
            max_precip[k] <- max(get(paste0("hydro_summer_", i, "_", j))$precip[(k - 6):k])
          }
        } else {
          max_precip[k] <- max(get(paste0("hydro_summer_", i, "_", j))$precip[(k - 6):k])
      }
    ...
    assign(paste0("hydro_winter_", i, "_", j), cbind(get(paste0("hydro_summer_", i, "_", j)), max_precip))      
  }
}
...
# GAM for lowlevel with avg/max drivers
```{r}
library(mgcv)

## which drivers have a high explanatory power per water level and per season 
# 10304, winter
gam_kbe_avg_10304_winter_test <- gam(lowlevel ~ s(max_precip, bs = "ps"), data = hydro_winter_10304_kbe, family = binomial(), method = "REML")
...
# 10304, winter
gam_kbe_avg_10304_winter <- gam(lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps") , data = hydro_winter_10304_kbe, family = binomial(), method = "REML")
summary(gam_kbe_avg_10304_winter)
plot(gam_kbe_avg_10304_winter)

# 10304, summer
gam_kbe_avg_10304_summer <- gam(lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps") , data = hydro_summer_10304_kbe, family = binomial(), method = "REML")
summary(gam_kbe_avg_10304_summer)
plot(gam_kbe_avg_10304_summer)

# 11502, winter
gam_kbe_avg_11502_winter <- gam(lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps") , data = hydro_winter_11502_kbe, family = binomial(), method = "REML")
