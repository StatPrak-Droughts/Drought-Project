...
```{r}
saveRDS(gam2_all_summer_20203, file = "./Plots/Jonas/gam2_all_summer_20203.Rdata")
saveRDS(gam_selected_summer_20203, file = "./Plots/Jonas/gam_selected_summer_20203.Rdata")
saveRDS(gam_selected_interact_summer_20203, file = "./Plots/Jonas/gam_selected_interact_summer_20203.Rdata")
...
```{r}
saveRDS(gam2_all_winter_20203, file = "./Plots/Jonas/gam2_all_winter_20203.Rdata")
saveRDS(gam_selected_winter_20203, file = "./Plots/Jonas/gam_selected_winter_20203.Rdata")
saveRDS(gam_selected_interact_winter_20203, file = "./Plots/Jonas/gam_selected_interact_winter_20203.Rdata")
```
...
### Sommer Modelle Speichern
```{r}
saveRDS(gam_all_summer_10304, file = "./Plots/Lisa/gam_all_summer_10304.Rdata")
saveRDS(gam_all_interac_summer_10304, file = "./Plots/Lisa/gam_all_interac_summer_10304.Rdata")
saveRDS(gam2_all_interac_summer_10304, file = "./Plots/Lisa/gam2_all_interac_summer_10304.Rdata")
saveRDS(gam3_all_interac_summer_10304, file = "./Plots/Lisa/gam3_all_interac_summer_10304.Rdata")
saveRDS(gam_selected_summer_10304, file = "./Plots/Lisa/gam_selected_summer_10304.Rdata")
saveRDS(gam_selected_interac_summer_10304, file = "./Plots/Lisa/gam_selected_interac_summer_10304.Rdata")
saveRDS(gam2_selected_interac_summer_10304, file = "./Plots/Lisa/gam2_selected_interac_summer_10304.Rdata")
```
...
```{r}
saveRDS(gam_all_winter_10304, file = "./Plots/Lisa/gam_all_winter_10304.Rdata")
saveRDS(gam_all_interac_winter_10304, file = "./Plots/Lisa/gam_all_interac_winter_10304.Rdata")
saveRDS(gam2_all_interac_winter_10304, file = "./Plots/Lisa/gam2_all_interac_winter_10304.Rdata")
saveRDS(gam3_all_interac_winter_10304, file = "./Plots/Lisa/gam3_all_interac_winter_10304.Rdata")
saveRDS(gam_selected_winter_10304, file = "./Plots/Lisa/gam_selected_winter_10304.Rdata")
saveRDS(gam_selected_interac_winter_10304, file = "./Plots/Lisa/gam_selected_interac_winter_10304.Rdata")
saveRDS(gam2_selected_interac_winter_10304, file = "./Plots/Lisa/gam2_selected_interac_winter_10304.Rdata")
```
...
### Interactions
```{r}
gam_interactions_summer_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps")  + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps")  + s(max_precip, by = avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps", by = avg_airtmp), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
