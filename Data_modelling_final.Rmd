...
## All
```{r}
gam_all_summer_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + avg_snowstorage + s(groundwaterdepth, bs = "ps") + avg_infiltration + max_precip + avg_snowstorage_drain, family = binomial(), data = hydro_summer_11502_kbe, method = "REML")
...
```{r}
# nur Treiber: avg_precip, avg_airtmp, avg_glorad, avg_soilwater, avg_snowstorage, grounwaterdepth um Multikollinearität zu vermeiden (in keinem der 6 Datensätze eine Korrelation von > 0.8 bzw. <-0.8)
gam_uni_selected_interac_winter_10304 <- gam(formula = lowlevel ~ YY  + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_soilwater, bs = "ps")+ s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps", by = avg_glorad), family = binomial(), data = hydro_winter_10304_kbe, method = "REML")
AIC(gam_uni_selected_interac_winter_10304)
summary(gam_uni_selected_interac_winter_10304)
plot(gam_uni_selected_interac_winter_10304, ylim = c(-7, 7))


gam_uni_selected_interac_summer_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps")+ s(groundwaterdepth, bs = "ps") + s(avg_airtmp, bs = "ps", by = avg_snowstorage), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
AIC(gam_uni_selected_interac_summer_10304)
summary(gam_uni_selected_interac_summer_10304)
plot(gam_uni_selected_interac_summer_10304, ylim = c(-7, 7))

# ab hier noch keine Interaktionen gesucht
gam_uni_selected_interac_winter_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps"), family = binomial(), data = hydro_winter_11502_kbe, method = "REML")
summary(gam_uni_selected_interac_winter_11502)
AIC(gam_uni_selected_interac_winter_11502)
BIC(gam_uni_selected_interac_winter_11502)
concurvity(gam_uni_selected_interac_winter_11502)
plot(gam_uni_selected_interac_winter_11502, ylim = c(-7, 7))


gam_uni_selected_interac_summer_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps"), family = binomial(), data = hydro_summer_11502_kbe, method = "REML")
summary(gam_uni_selected_interac_summer_11502)
AIC(gam_uni_selected_interac_summer_11502)
BIC(gam_uni_selected_interac_summer_11502)
concurvity(gam_uni_selected_interac_summer_11502)
plot(gam_uni_selected_interac_summer_11502, ylim = c(-7, 7))


gam_uni_selected_interac_winter_20203 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps"), family = binomial(), data = hydro_winter_20203_kbe, method = "REML")
summary(gam_uni_selected_interac_winter_20203)
AIC(gam_uni_selected_interac_winter_20203)
BIC(gam_uni_selected_interac_winter_20203)
concurvity(gam_uni_selected_interac_winter_20203)
plot(gam_uni_selected_interac_winter_20203, ylim = c(-7, 7))


gam_uni_selected_interac_summer_20203 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps"), family = binomial(), data = hydro_summer_20203_kbe, method = "REML")
summary(gam_uni_selected_interac_summer_20203)
AIC(gam_uni_selected_interac_summer_20203)
BIC(gam_uni_selected_interac_summer_20203)
concurvity(gam_uni_selected_interac_summer_20203)
plot(gam_uni_selected_interac_summer_20203, ylim = c(-7, 7))
```