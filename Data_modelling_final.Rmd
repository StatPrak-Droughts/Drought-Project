...
hydro_summer_10304_pred_now_lowlevel <- hydro_summer_10304_pred[-which(hydro_summer_10304_test$lowlevel == 1)]
hist(hydro_summer_10304_pred_now_lowlevel, na.rm = TRUE, breaks = 100, xlab = "Prädiktierte Wahrscheinlichkeit für Niedrigwasserevent", ylab = "Häufigkeit", main = "Isar Mittenwald, Sommer, Fälle: kein Niedrigwasserevent")
...
hydro_winter_11502_pred_now_lowlevel <- hydro_winter_11502_pred[-which(hydro_winter_11502_test$lowlevel == 1)]
hist(hydro_winter_11502_pred_now_lowlevel, na.rm = TRUE, breaks = 100, xlab = "Prädiktierte Wahrscheinlichkeit für Niedrigwasserevent", ylab = "Häufigkeit", main = "Iller Kempten, Winter, Fälle: kein Niedrigwasserevent")
...
hydro_summer_11502_pred_now_lowlevel <- hydro_summer_11502_pred[-which(hydro_summer_11502_test$lowlevel == 1)]
hist(hydro_summer_11502_pred_now_lowlevel, na.rm = TRUE, breaks = 100, xlab = "Prädiktierte Wahrscheinlichkeit für Niedrigwasserevent", ylab = "Häufigkeit", main = "Iller Kempten, Sommer, Fälle: kein Niedrigwasserevent")
...
hydro_winter_20203_pred_now_lowlevel <- hydro_winter_20203_pred[-which(hydro_winter_20203_test$lowlevel == 1)]
hist(hydro_winter_20203_pred_now_lowlevel, na.rm = TRUE, breaks = 100, xlab = "Prädiktierte Wahrscheinlichkeit für Niedrigwasserevent", ylab = "Häufigkeit", main = "Fränkische Saale Salz, Winter, Fälle: kein Niedrigwasserevent")
...
hydro_summer_20203_pred_now_lowlevel <- hydro_summer_20203_pred[-which(hydro_summer_20203_test$lowlevel == 1)]
hist(hydro_summer_20203_pred_now_lowlevel, na.rm = TRUE, breaks = 100, xlab = "Prädiktierte Wahrscheinlichkeit für Niedrigwasserevent", ylab = "Häufigkeit", main = "Fränkische Saale Salz, Sommer, Fälle: kein Niedrigwasserevent")
```
