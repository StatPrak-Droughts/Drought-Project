...
hydro_winter_11502_test <- hydro_summer_11502 %>% filter(member != "kbe")
...
hydro_winter_10304_test <- hydro_summer_10304 %>% filter(member != "kbe")
...
hydro_winter_20203_test <- hydro_summer_20203 %>% filter(member != "kbe")
hydro_winter_20203_test$lowlevel <- as.logical(hydro_winter_20203_test$lowlevel)

# gam_uni_selected_interac_winter_10304
hydro_winter_11502_pred <- predict(gam_uni_selected_interac_winter_10304, hydro_winter_11502_test, type = "response")
roc.plot(hydro_winter_11502_test$lowlevel, hydro_winter_11502_pred)

hydro_winter_11502_predROC <- prediction(as.list(hydro_winter_11502_pred), as.list(hydro_winter_11502_test$lowlevel))
hydro_winter_11502_perf <- performance(hydro_winter_11502_predROC, "tpr", "fpr")
