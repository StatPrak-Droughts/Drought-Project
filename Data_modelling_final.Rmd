...
```{r}
#saveRDS(gam2_all_summer_20203, file = "./Plots/Jonas/gam2_all_summer_20203.gam")
#saveRDS(gam_selected_summer_20203, file = "./Plots/Jonas/gam_selected_summer_20203.gam")
#saveRDS(gam_selected_interact_summer_20203, file = "./Plots/Jonas/gam_selected_interact_summer_20203.gam")
...
```{r}
#saveRDS(gam2_all_winter_20203, file = "./Plots/Jonas/gam2_all_winter_20203.gam")
#saveRDS(gam_selected_winter_20203, file = "./Plots/Jonas/gam_selected_winter_20203.gam")
#saveRDS(gam_selected_interact_winter_20203, file = "./Plots/Jonas/gam_selected_interact_winter_20203.gam")
```
...
plot(gam_all_summer_10304, select = 6)
plot(gam_all_summer_10304, select = 7, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 8, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 9, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 10)

plot(gam_all_summer_10304, select = 1, se = FALSE)
plot(gam_all_summer_10304, select = 2, se = FALSE, ylim = c(-10, 10))
plot(gam_all_summer_10304, select = 3, se = FALSE, ylim = c(-10, 10))
plot(gam_all_summer_10304, select = 4, se = FALSE, ylim = c(-10, 10))
plot(gam_all_summer_10304, select = 5, se = FALSE, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 6, se = FALSE)
plot(gam_all_summer_10304, select = 7, se = FALSE, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 8, se = FALSE, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 9, se = FALSE, ylim = c(-40, 40))
plot(gam_all_summer_10304, select = 10, se = FALSE)

# GAM: all possible drivers (avg_snowstorage, avg_infiltration, max_precip, avg_snowstorage_drain linear)
gam2_all_summer_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + avg_snowstorage + s(groundwaterdepth, bs = "ps") + avg_infiltration + max_precip + avg_snowstorage_drain, family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
summary(gam2_all_summer_10304)
AIC(gam2_all_summer_10304)
concurvity(gam2_all_summer_10304)
...
plot(gam2_all_summer_10304, select = 5, ylim = c(-40, 40))
plot(gam2_all_summer_10304, select = 6, ylim = c(-40, 40))


# Prädiktionen bei anderen membern
# alle anderen member
plot(x = exp(predict(gam2_all_summer_10304, newdata = hydro_summer_10304[hydro_summer_10304$member != "kbe", ]))/(1 + exp(predict(gam2_all_summer_10304, newdata = hydro_summer_10304[hydro_summer_10304$member != "kbe", ]))), y = as.logical(hydro_summer_10304[hydro_summer_10304$member != "kbe", ]$lowlevel), col = alpha("black", 0.005))
gam2_all_summer_10304_pred_error <- sum((exp(predict(gam2_all_summer_10304, newdata = hydro_summer_10304[hydro_summer_10304$member != "kbe", ]))/(1 + exp(predict(gam2_all_summer_10304, newdata = hydro_summer_10304[hydro_summer_10304$member != "kbe", ]))) - (as.numeric(hydro_summer_10304[hydro_summer_10304$member != "kbe", ]$lowlevel) - 1))^2, na.rm = TRUE)
```
...
# Effekte von avg_snowstorage_drain und avg_relhum nicht signifikant; alleinige Devianzerklärungskraft von max_precip sehr gering 
gam_selected_summer_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + avg_snowstorage + s(groundwaterdepth, bs = "ps") + avg_infiltration, family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
...
```{r}
gam_selected_interac_summer_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + avg_snowstorage + s(groundwaterdepth, bs = "ps") + avg_infiltration + s(groundwaterdepth, bs = "ps", by = avg_soilwater) + s(avg_glorad, bs = "ps", by = avg_soilwater), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
...
plot(gam_selected_interac_summer_10304, select = 7, ylim = c(-40, 40))
...
gam2_selected_interac_summer_10304_pred_error <- sum((exp(predict(gam_selected_interac_summer_10304, newdata = hydro_summer_10304[hydro_summer_10304$member != "kbe", ]))/(1 + exp(predict(gam_selected_interac_summer_10304, newdata = hydro_summer_10304[hydro_summer_10304$member != "kbe", ]))) - (as.numeric(hydro_summer_10304[hydro_summer_10304$member != "kbe", ]$lowlevel) - 1))^2, na.rm = TRUE)




gam2_selected_interac_summer_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + avg_snowstorage + s(groundwaterdepth, bs = "ps") + avg_infiltration + s(groundwaterdepth, bs = "ps", by = avg_soilwater) + s(groundwaterdepth, bs = "ps", by = avg_glorad), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
...
plot(gam2_selected_interac_summer_10304, select = 7, ylim = c(-10, 10))
...
### Sommer Modelle Speichern
```{r}
#saveRDS(gam_all_summer_10304, file = "./Plots/Lisa/gam_all_summer_10304.gam")
#saveRDS(gam_all_interac_summer_10304, file = "./Plots/Lisa/gam_all_interac_summer_10304.gam")
#saveRDS(gam2_all_interac_summer_10304, file = "./Plots/Lisa/gam2_all_interac_summer_10304.gam")
#saveRDS(gam3_all_interac_summer_10304, file = "./Plots/Lisa/gam3_all_interac_summer_10304.gam")
#saveRDS(gam_selected_summer_10304, file = "./Plots/Lisa/gam_selected_summer_10304.gam")
#saveRDS(gam_selected_interac_summer_10304, file = "./Plots/Lisa/gam_selected_interac_summer_10304.gam")
#saveRDS(gam2_selected_interac_summer_10304, file = "./Plots/Lisa/gam2_selected_interac_summer_10304.gam")
```
...
concurvity(gam_all_winter_10304)
plot(gam_all_winter_10304, select = 1, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 2, ylim = c(-5, 5))
plot(gam_all_winter_10304, select = 3, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 4, ylim = c(-5, 5))
plot(gam_all_winter_10304, select = 5, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 6, ylim = c(-5, 5))
plot(gam_all_winter_10304, select = 7, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 8, ylim = c(-400, 400))
plot(gam_all_winter_10304, select = 9, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 10)

plot(gam_all_winter_10304, select = 1, se = FALSE, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 2, se = FALSE, ylim = c(-5, 5))
plot(gam_all_winter_10304, select = 3, se = FALSE, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 4, se = FALSE, ylim = c(-5, 5))
plot(gam_all_winter_10304, select = 5, se = FALSE, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 6, se = FALSE, ylim = c(-5, 5))
plot(gam_all_winter_10304, select = 7, se = FALSE, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 8, se = FALSE, ylim = c(-400, 400))
plot(gam_all_winter_10304, select = 9, se = FALSE, ylim = c(-80, 80))
plot(gam_all_winter_10304, select = 10, se = FALSE)


# GAM: all possible drivers (avg_airtmp, avg_infiltration linear)
gam2_all_winter_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + avg_airtmp + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + avg_infiltration + s(max_precip, bs = "ps") + s(avg_snowstorage_drain, bs = "ps"), family = binomial(), data = hydro_winter_10304_kbe, method = "REML")
summary(gam2_all_winter_10304)
plot(gam2_all_winter_10304, select = 1, ylim = c(-80, 80))
plot(gam2_all_winter_10304, select = 2, ylim = c(-80, 80))
plot(gam2_all_winter_10304, select = 3, ylim = c(-5, 5))
plot(gam2_all_winter_10304, select = 4, ylim = c(-80, 80))
plot(gam2_all_winter_10304, select = 5, ylim = c(-5, 5))
plot(gam2_all_winter_10304, select = 6, ylim = c(-80, 80))
plot(gam2_all_winter_10304, select = 7, ylim = c(-80, 80))
plot(gam2_all_winter_10304, select = 8)

# Prädiktionen bei anderen membern
# alle anderen member
plot(x = exp(predict(gam2_all_winter_10304, newdata = hydro_winter_10304[hydro_winter_10304$member != "kbe", ]))/(1 + exp(predict(gam2_all_winter_10304, newdata = hydro_winter_10304[hydro_winter_10304$member != "kbe", ]))), y = as.logical(hydro_winter_10304[hydro_winter_10304$member != "kbe", ]$lowlevel), col = alpha("black", 0.005))
gam2_all_winter_10304_pred_error <- sum((exp(predict(gam2_all_winter_10304, newdata = hydro_winter_10304[hydro_winter_10304$member != "kbe", ]))/(1 + exp(predict(gam2_all_winter_10304, newdata = hydro_winter_10304[hydro_winter_10304$member != "kbe", ]))) - (as.numeric(hydro_winter_10304[hydro_winter_10304$member != "kbe", ]$lowlevel) - 1))^2, na.rm = TRUE)
```
...
gam_selected_winter_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + avg_infiltration + s(avg_snowstorage_drain, bs = "ps"), family = binomial(), data = hydro_winter_10304_kbe, method = "REML")
...
# GAM: selected variables with interactions
```{r}
gam_selected_interac_winter_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + avg_infiltration + s(avg_snowstorage_drain, bs = "ps") + s(avg_snowstorage, bs = "ps", by = groundwaterdepth) + s(avg_glorad, bs = "ps", by = groundwaterdepth), family = binomial(), data = hydro_winter_10304_kbe, method = "REML")

summary(gam_selected_interac_winter_10304)
AIC(gam_selected_interac_winter_10304)

gam2_selected_interac_winter_10304 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + avg_infiltration + s(avg_snowstorage_drain, bs = "ps") +  s(avg_snowstorage, bs = "ps", by = groundwaterdepth) + s(avg_snowstorage, bs = "ps", by = avg_glorad), family = binomial(), data = hydro_winter_10304_kbe, method = "REML")
...
```{r}
#saveRDS(gam_all_winter_10304, file = "./Plots/Lisa/gam_all_winter_10304.gam")
#saveRDS(gam_all_interac_winter_10304, file = "./Plots/Lisa/gam_all_interac_winter_10304.gam")
#saveRDS(gam2_all_interac_winter_10304, file = "./Plots/Lisa/gam2_all_interac_winter_10304.gam")
#saveRDS(gam3_all_interac_winter_10304, file = "./Plots/Lisa/gam3_all_interac_winter_10304.gam")
#saveRDS(gam_selected_winter_10304, file = "./Plots/Lisa/gam_selected_winter_10304.gam")
#saveRDS(gam_selected_interac_winter_10304, file = "./Plots/Lisa/gam_selected_interac_winter_10304")
#saveRDS(gam2_selected_interac_winter_10304, file = "./Plots/Lisa/gam2_selected_interac_winter_10304.gam")
```




#saveRDS(gam_all_winter_10304, file = "./Plots/Lisa/gam_all_winter_10304.gam")# Iller Kempten
```{r}
...
### Trimed
```{r}
gam_trimmed_winter_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps")  + s(avg_snowstorage_drain, bs = "ps"), family = binomial(), data = hydro_winter_11502_kbe, method = "REML")
...
### Interactions
```{r}
gam_interactions_winter_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps")  + s(avg_snowstorage_drain, bs = "ps") + s(avg_precip, bs = "ps", by = avg_soilwater) + s(avg_snowstorage, bs = "ps", by = avg_airtmp), family = binomial(), data = hydro_winter_11502_kbe, method = "REML")
...
## All
```{r}
gam_all_summer_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps") + s(avg_relhum, bs = "ps") + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps") + s(max_precip, bs = "ps") + s(avg_snowstorage_drain, bs = "ps"), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
summary(gam_all_summer_11502)
```
##Trimmed
```{r}
gam_trimmed_summer_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps")  + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps") + s(max_precip, bs = "ps"), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
...
### Interactions
```{r}
gam_interactions_summer_11502 <- gam(formula = lowlevel ~ YY + s(avg_precip, bs = "ps") + s(avg_airtmp, bs = "ps") + s(avg_glorad, bs = "ps")  + s(avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps") + s(groundwaterdepth, bs = "ps") + s(avg_infiltration, bs = "ps")  + s(max_precip_scaled, by = avg_soilwater, bs = "ps") + s(avg_snowstorage, bs = "ps", by = avg_airtmp), family = binomial(), data = hydro_summer_10304_kbe, method = "REML")
